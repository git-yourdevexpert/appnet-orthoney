...
class OAM_Hooks {
    ...
    public function __construct() {
        ...
        add_action('pre_user_query', array($this,'search_users_by_fullname'));
    }
                ...
                $menus = [
                    'sales-rep-menu' => [ // Menu slug
                        ...
                        'items' => [
                            ...
                            'Customers Orders' => SALES_REPRESENTATIVE_DASHBOARD_LINK . 'orders-list/',
    ...
    public function search_users_by_fullname($query) {
        global $wpdb;

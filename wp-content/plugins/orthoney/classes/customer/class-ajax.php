        ...
        if (!empty($items)) {
            foreach ($items as $item) {
                ...
                $data[] = [
                    ...
                    'date' => esc_html($created_date),
                    'action' => "<a href='$resume_url' class='button-icon-underline'>" . ($failed == 1 ? '<img src="'.OH_PLUGIN_DIR_URL .'assets/image/resume.png" alt="View Recipients"> View Recipients' : '<img src="'.OH_PLUGIN_DIR_URL .'assets/image/resume.png" alt=""> Resume Order') . "</a> " . ($failed != 1 ? $download_button : '')
                ];
            }
        }

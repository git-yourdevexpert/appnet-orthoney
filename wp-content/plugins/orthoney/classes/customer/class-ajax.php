        ...
        if (!empty($results)) {
            foreach ($results as $data) {
                ...
                if (!empty($data->csv_name)) {
                    ...
                    $download_button = "<a  data-tippy='Download' data-popup='#download' href='".esc_url($download_url)."' class='w-btn us-btn-style_1 outline-btn round-btn' download><i class='far fa-download'></i></a>";
                }
    
                $table_content .= "<tr><td>" . esc_html($data->id) . "</td><td>". esc_html($created_date). "</td><td>" . esc_html($data->name) . "</td><td> <a href='".esc_url($resume_url)."' data-tippy='Resume Order' data-popup='#resume-order' class='w-btn us-btn-style_1 outline-btn sm-btn'>Resume Order</a> ".$download_button." </td></tr>";
            }
        } else {

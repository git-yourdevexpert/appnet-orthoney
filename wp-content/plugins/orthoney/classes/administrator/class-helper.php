                        ...
                        <div class="sub-heading">
                            ...
                            <div>
                                <ul class="commission-calc">
                                    ...
                                    <li><span>Your Selling Price </span><span>'.wc_price($unit_price).'</span></li>
                                    <li><span>Your Unit Cost </span><span>'.wc_price($unit_cost).'</span></li>
                                    <li><span>Your Unit Profit  <div class="tooltip" data-tippy="(Your Selling Price - Your Unit Cost )"></div></span><span>'.wc_price($unit_price - $unit_cost).'</span></li>
                        ...
                        <div class="sub-heading">
                            ...
                            <div>
                                <ul class="commission-calc">
                                    ...
                                    <li ><span>Your Total Cost (ORT`s Share) <div class="tooltip" data-tippy="(Your Fundraising Quantity * Your Unit Cost )"></div></span><span>'.(($details['current_year_total_quantity'] < 50) ? wc_price(0)  : wc_price($fundraising_total)).'</span></li>
                                    <li class="total"><span>Your Total Fundraising Profit <div class="tooltip" data-tippy="(Your Fundraising Quantity * Your Unit Profit)"></div></span><span>'.(($details['current_year_total_quantity'] < 50) ? wc_price(0)  : wc_price($total_commission)).'</span></li>
                            ...
                            <div>
                                <ul class="commission-calc">
                                    ...
                                    <li><span>Your Unit Profit</span><span>N/A</span></li>
                                     <li><span>Your Wholesale Total Sales <div class="tooltip" data-tippy="(Your Wholesale Quantity * Your Selling Price )"></div></span><span>'.wc_price($wholesale_ort_share_cost).'</span></li>
                                     
                                     <li><span>Your Total Cost (ORT`s Share) <div class="tooltip" data-tippy="(Your Wholesale Quantity * Your Unit Cost)"></div></span><span>'.wc_price($wholesale_total).'</span></li>

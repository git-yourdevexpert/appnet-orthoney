    ...
    public function __construct() {
     ...
     public static function administrator_dashboard_navbar($user_roles = array()){
        ...
        if ( in_array( 'administrator', $user_roles)) {
            ...
            $output .= '<div class="btn"><a href="' . esc_url(ADMINISTRATOR_DASHBOARD_LINK.'/order-list/') . '">Order List</a></div>';
            if ( ! in_array( 'affiliate_team_member', $user_roles)) {
                ...
                $output .= '<div class="btn"><a href="' . esc_url(ADMINISTRATOR_DASHBOARD_LINK.'/user-list/') . '">User List</a></div>';
            }

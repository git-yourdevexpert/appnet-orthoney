    ...
    public static function affiliate_details($affiliate_id, $details)
    {
        ...
        if ($details['token'] != '') {
            ...
            if($details['total_quantity'] > 50 && $details['total_quantity'] < 100){
                 ...
                 $total_quantity_commission = '<div class="dashboard-heading block-row"><div class="item error-message-box"><div class="row-block"><p >You`re very close to your  Profit-Sharing level! Add just ' . (100 - $details['total_quantity']) . ' more jars to reach 100 jars and unlock additional benefits.</p></div></div></div>';
            }
            $html .= '

...
<form class="woocommerce-EditAccountForm edit-account" action="" method="post" <?php do_action( 'woocommerce_edit_account_form_tag' ); ?> >
	...
	<p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
		...
		<input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="account_first_name" id="account_first_name" autocomplete="given-name" value="<?php echo esc_attr( $user->first_name ) ?: $first_name; ?>" />
	</p>
	
	<p class="woocommerce-form-row woocommerce-form-row--last form-row form-row-last">
		<label for="account_last_name"><?php esc_html_e( 'Last name', 'woocommerce' ); ?>&nbsp;<span class="required">*</span></label>
		<input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="account_last_name" id="account_last_name" autocomplete="family-name" value="<?php echo esc_attr( $user->last_name )?: $last_name; ?>" />
	</p>
	<div class="clear"></div>
	...
	<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
		...
		<input style="background-color: #ddd;" type="email" class="woocommerce-Input woocommerce-Input--email input-text" name="account_email" id="account_email" readonly autocomplete="email" value="<?php echo esc_attr( $user->user_email ); ?>" />
	</p>
...
<div class="woocommerce-change-password-wrapper">
    ...
    <form class="woocommerce-ChangePasswordForm change-password" action="" method="post">
        ...
        <p>
            <?php wp_nonce_field('save_password', 'save-password-nonce'); ?>
            <button type="submit" class="woocommerce-Button button" name="save_password" value="<?php esc_attr_e('Save Password', 'woocommerce'); ?>"><?php esc_html_e('Save Password', 'woocommerce'); ?></button>
        </p>
    </form>
</div>

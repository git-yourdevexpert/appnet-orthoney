...
<?php else : ?>
	...
	<div class="heading-title"><h3 class="block-title"><?php echo apply_filters( 'woocommerce_my_account_edit_address_title', $page_title, $load_address ); ?></h3></div><?php // @codingStandardsIgnoreLine ?>

        ...
        <div class="order-process-dashboard">
            <div class="dashboard-block">
                ...
                <div class="block-row">
                    ...
                    $title = 'Place Order';
                    $content = '<h3 class="text-color-yellow">A Jar of Honey, A World of Meaning</h3><h4 class="block-title">Every jar helps fund meaningful programs and spread holiday joy!</h4>';

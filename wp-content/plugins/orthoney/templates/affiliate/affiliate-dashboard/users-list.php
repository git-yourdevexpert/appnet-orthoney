        ...
        <tbody>
            ...
            if (!empty($affiliate_users)) {
                foreach ($affiliate_users as $user) {
                    $affiliate_type = get_user_meta($user->ID, 'user_field_type', true);
                ...
                ?>
                <tr><td colspan="5" class="no-available-msg">No Team member is found!</td></tr>
                <?php
            }
            ?>
        </tbody>

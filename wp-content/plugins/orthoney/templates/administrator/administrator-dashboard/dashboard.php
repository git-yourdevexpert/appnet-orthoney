            ...
            <div class="dashboard-block">
                ...
                <div class="two-col-grid">
                    ...
                    <div class="cl-right">
                        <div class="recipient-lists-block custom-table">
                            <div class="row-block">
                                <h4>Manage Sales Representatives</h4>
                                <div class="see-all">
                    ...
                    <div class="cl-left">
                        <div class="recipient-lists-block custom-table">
                            <div class="row-block">
                                ...
                                <div class="see-all">
                                    <a class="w-btn us-btn-style_1" href="<?php echo esc_url(OAM_Helper::$administrator_dashboard_link.'organization-commission/'); ?>">See All</a> 
                                </div>
                            </div>
                        </div>
                    </div>
